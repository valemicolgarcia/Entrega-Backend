...
router.post("/:cid/product/:pid", async (req, res) => {
  ...
  try {
    const actualizarCarrito = await cartManager.agregarProductoAlCarrito(
      ...
      productId,
      quantity
    ); //llama a agregarproducto al carrito de cartmanager
...
router.delete("/:cid/product/:pid", async (req, res) => {
  try {
    ...
    const updatedCart = await cartManager.eliminarProductoDelCarrito(
      cartId,
      productId
    ); //llama a metodo de cartManager para eliminar producto del carrito
...
router.put("/:cid", async (req, res) => {
  ...
  try {
    const updatedCart = await cartManager.actualizarCarrito(
      cartId,
      updatedProducts
    ); //recibe un nuevo array de productos en req.body y reemplaza los productos del carrito con metodo de cartManager
