...
if (productForm) {
  productForm.addEventListener("submit", async (e) => {
    ...
    const formData = new FormData(productForm); // captura todos los campos incluyendo el archivo
    ...
    try {
      ...
      socket.emit("nuevoProductoAgregado"); // para que el servidor vuelva a emitir productos
